...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-party_business_hours',
    download_url='https://github.com:nantic/trytond-party_business_hours.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-party_business_hours.git'
    },
    classifiers=[
